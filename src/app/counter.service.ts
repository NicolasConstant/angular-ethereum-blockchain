...
export class CounterService {
  ...
  increment() {
    this.contractInstance.increment({ from: this.web3js.eth.accounts[0] }, this.handler.bind(this));
    this.count = this.contractInstance.getCounts.call().toString();
  }

  decrement() {
    this.contractInstance.decrement({ from: this.web3js.eth.accounts[0] }, this.handler.bind(this));
    this.count = this.contractInstance.getCounts.call().toString();
  }
